...
write_parquet_table(
    final_df,
    "pyspark_catalog.assignment_schema.employee_parquet",
    "dbfs:/Volumes/pyspark_catalog/assignment_schema/assignment_volume/employee_parquet"
)

print("Parquet External Table Created")
...
write_csv_table(
    final_df,
    "pyspark_catalog.assignment_schema.employee_csv",
    "dbfs:/Volumes/pyspark_catalog/assignment_schema/assignment_volume/employee_csv"
)
...
spark.sql("""
SHOW TABLES IN pyspark_catalog.assignment_schema
""").show()
